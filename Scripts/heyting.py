...
PRINCIPLES: dict[str, Principle] = {
    ...
    "PierceOrPierce'": disjoin(peirce, peirce, swap_right=True),
    "ImpOrOrImpOr'": disjoin(imp_or, imp_or, swap_right=True),
    "LukOrLuk'": disjoin(lukasiewicz, lukasiewicz, swap_right=True),
    "Em1OrPierce": disjoin(excluded_middle, peirce),
    "PierceOrDeMorgan": disjoin(peirce, de_morgan),
    "DeMorganOrImpOr": disjoin(de_morgan, imp_or),
    "PeirceOrImpOr": disjoin(peirce, imp_or),
    "PeirceOrImpOr'": disjoin(peirce, imp_or, swap_right=True),
    "Em1OrPeirce21":     lambda H,a,b: (a | H.neg(a)) | peirce(H,b,a),
    "NotNot1OrPeirce21": lambda H,a,b: H.imp(H.neg(H.neg(a)), a) | peirce(H,b,a),
    "CM1OrPeirce21":     lambda H,a,b: H.imp(H.imp(H.neg(a),a),a) | peirce(H,b,a),
